...
compute a convolution on an 8-bit image, libvips will examine the convolution
...
url="http://www.graphicsmagick.org">GraphicsMagick</ulink> library, so libvips
...
By default, libvips caches the last 1,000 operation calls. You can also control
